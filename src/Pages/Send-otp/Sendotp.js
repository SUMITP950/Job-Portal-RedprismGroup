...
export default function Sendotp(props) {
  ...
  return (
    <>
        ...
        <div class="bg order-1 order-md-2 d-none d-md-block login-bg-img-otp">
        </div>
                                    ...
                                    <form action="#" method="post">
                                        <div class="form-group last mb-3">
                                            ...
                                            <input type="password" class="form-control"
                                                placeholder="Enter Mobile Number" id="password" required />
                                        </div>

                                        <button type="submit" class="btn btn-block btn-primary"><strong>Send
                                                OTP</strong></button>

                                        <div class="d-flex mb-3 align-items-center mt-3">
                                            <span class="ml-auto"><a href="#" class="forgot-pass">Back to
                                                    Login</a></span>
